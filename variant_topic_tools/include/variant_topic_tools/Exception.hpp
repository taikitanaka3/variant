...
namespace variant_topic_tools
{
    ...
    */
    class NullPointerException : public rclcpp::Exception
    {
    public:
    ...
    */
    class InvalidOperationException : public rclcpp::Exception
    {
    public:
        /** \brief Default constructor
      */
    ...
    */
    class InvalidDataTypeException : public rclcpp::Exception
    {
    public:
        /** \brief Default constructor
      */
    ...
    */
    class ImmutableDataTypeException : public rclcpp::Exception
    {
    public:
        /** \brief Default constructor
      */
    ...
    */
    class NoSuchDataTypeException : public rclcpp::Exception
    {
    public:
        /** \brief Constructor
      */
    ...
    */
    class AmbiguousDataTypeIdentifierException : public rclcpp::Exception
    {
    public:
        /** \brief Constructor
      */
    ...
    */
    class DataTypeMismatchException : public rclcpp::Exception
    {
    public:
        /** \brief Constructor
      */
    ...
    */
    class AmbiguousMemberNameException : public rclcpp::Exception
    {
    public:
        /** \brief Constructor
      */
    ...
    */
    class NoSuchMemberException : public rclcpp::Exception
    {
    public:
    ...
    */
    class InvalidMessageMemberException : public rclcpp::Exception
    {
    public:
        /** \brief Default constructor
      */
    ...
    */
    class MD5SumMismatchException : public rclcpp::Exception
    {
    public:
        /** \brief Constructor
      */
    ...
    */
    class InvalidMessageTypeException : public rclcpp::Exception
    {
    public:
        /** \brief Constructor
      */
    ...
    */
    class MessageTypeMismatchException : public rclcpp::Exception
    {
    public:
        /** \brief Constructor
      */
    ...
    *   definition
    */
    class DefinitionParseException : public rclcpp::Exception
    {
    public:
        /** \brief Constructor
      */
    ...
    */
    class PackageNotFoundException : public rclcpp::Exception
    {
    public:
        /** \brief Constructor
      */
    ...
    */
    class FileOpenException : public rclcpp::Exception
    {
    public:
        /** \brief Constructor
      */
    ...
    */
    class InvalidSerializerException : public rclcpp::Exception
    {
    public:
        /** \brief Default constructor
      */
